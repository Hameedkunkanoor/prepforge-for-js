...
window.DEEPDIVES = [
  ...
  { id: "dd-tsdb", cat: "Data & Storage", icon: "⏱️", level: "Intermediate", title: "Time-Series & Graph DBs", tagline: "Specialized stores for metrics and relationships.", chapters: [
    { h: "Time-series", bullets: ["Append-heavy, time-indexed; downsampling + retention; InfluxDB/Timescale. Monitoring, IoT."] },
    { h: "Graph", bullets: ["Nodes+edges; traversals beat recursive joins; Neo4j/Neptune. Social, fraud, recommendations."] },
  ]},
  ...
  { id: "dd-deploy", cat: "Reliability", icon: "🚀", level: "Intermediate", title: "Safe Deploys: Canary, Blue-Green, Flags", tagline: "Ship without taking the site down.", chapters: [
    { h: "Canary", p: ["Send a small % to the new version; ramp if healthy, roll back if not."] },
    { h: "Blue-green", p: ["Two environments; switch traffic after validation; instant rollback."] },
    { h: "Feature flags", p: ["Toggle behavior without deploy; ship dark, enable when ready."] },
  ]},
];
